...
export const productos: Producto[] = [
  ...
  },
  {
    ...
    precio: 1890,
    colores: [{ id: "blanco", nombre: "Blanco", hex: "#f2f1ec", foto: "studio-pair" }],
  ...
  },
  {
    ...
    precio: 2450,
    precioAntes: 2790,
    colores: [{ id: "rojo", nombre: "Suela roja", hex: "#ff3b30", foto: "concepto-azul" }],
  ...
  },
  {
    ...
    precio: 2290,
    colores: [{ id: "carbon", nombre: "Carbón", hex: "#2b2b2b", foto: "sombra" }],
